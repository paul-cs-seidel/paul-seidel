 ...
 * Stilfläche: ../../styles/pages/projects.css.
 */
...
export const DEFAULT_GALLERY_OPTIONS = Object.freeze({
  setCount: 3, // identische Sets für den nahtlosen Loop
  ariaLabel: 'Looping project gallery',
  // Label des .mouse-Cursors beim Hover über ein Wheel-Item (sprachbewusst).
  ...
  /** Track-Grundtransform: Mitte des 3er-Loops, vertikal zentriert. */
  trackTransform: Object.freeze({ xPercent: -33.333333333333336, yPercent: -50 }),

  /** Ticker-Scroll-Physik. */
  scroll: Object.freeze({
    baseSpeed: 48, // px/s Grund-Autoscroll (× speedScale)
    maxDelta: 0.064, // dt-Deckel in s
    friction: 0.018, // wheelVelocity *= friction^dt
    velocityCutoff: 0.08, // darunter wheelVelocity = 0
    wheelClamp: 2800, // |wheelVelocity| ≤ 2800
    wheelLineHeight: 42, // deltaMode==1 (Zeilen) → ×42 px
    wheelFactor: 1,
  }),

  /** speedScale-Rampe bei Pause/Resume/Freeze. */
  speed: Object.freeze({
