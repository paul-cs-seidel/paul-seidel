...
const PROJECTS = [
  ...
  { id: 'siderun',               title: 'SIDERUN',            category: { en: 'Demo site', de: 'Demoseite'   }, role: { en: 'DESIGN / FRONT-END DEVELOPMENT / 3D MODELING',  de: 'デザイン / フロントエンド開発 / 3Dモデリング'  }, summary: { en: 'Web experience for WIRED Innovation Award 2025.',               de: 'WIRED Innovation Award 2025 のWebサイト実装。'              },        href: 'https://paul-cs-seidel.github.io/SideRun/',       image: '/assets/projects/siderun.png'              },
  { id: 'portfolio_2026',        title: 'Portfolio 2026',     category: { en: 'Web site',  de: 'Webseite'    }, role: { en: 'DESIGN / FRONT-END DEVELOPMENT / 3D MODELING',  de: 'デザイン / フロントエンド開発 / 3Dモデリング'  }, summary: { en: 'Prototype portfolio exploring interactive 3D and frontend motion.', de: 'インタラクティブな3D表現とフロントエンドモーション。'        },         href: 'https://paul-seidel.pages.dev',                   image: '/assets/Hero.png' },
  { id: 'aurascent',             title: 'AuraScent',          category: { en: 'Web site',  de: 'Webseite'    }, role: { en: 'DESIGN / FRONT-END DEVELOPMENT / 3D MODELING',  de: 'デザイン / フロントエンド開発 / 3Dモデリング'  }, summary: { en: '3D motion demo focused on spatial composition and interaction.',  de: '空間構成とインタラクションにフォーカスした3Dモーションデモ。' },           href: 'https://aurascent-3b4i.onrender.com',              image: '/assets/projects/aurascent.png'             },
  { id: 'kernwerksystems',       title: 'Kernwerk Systems',    category: { en: 'Web site',  de: 'Webseite'    }, role: { en: 'DESIGN / FRONT-END DEVELOPMENT / 3D MODELING',  de: 'デザイン / フロントエンド開発 / 3Dモデリング'  }, summary: { en: 'Demo exploring project browsing and motion-driven interaction.',  de: 'プロジェクト閲覧とモーションによるインタラクションデモ。'    },           href: 'https://kernwerk-systems.pages.dev',              image: '/assets/projects/kernwerksystems.png'              },
  { id: 'mensuratemporis',       title: 'Mensura Temporis',    category: { en: 'Demo site', de: 'Demoseite'   }, role: { en: 'DESIGN / FRONT-END DEVELOPMENT',                de: 'デザイン / フロントエンド開発'               }, summary: { en: 'Portfolio site from 2022.',                                      de: '2022年に制作したポートフォリオサイト。'                      },         href: 'https://mensura-temporis.pages.dev',              image: '/assets/projects/mensuratemporis.png'      },
  { id: 'ihkap1',                title: 'IHK AP 1 Lernseite', category: { en: 'Web site',  de: 'Webseite'    }, role: { en: '3D MODELING / MOTION',                          de: '3Dモデリング / モーション'                  }, summary: { en: 'Showreel presenting motion, WebGL and frontend experiments.',    de: 'モーション・WebGL・フロントエンド表現のショーリール。'       },           href: 'https://paul-cs-seidel.github.io/IHK-Lernseite/',  image: '/assets/projects/ihkap1.png'           }
];
