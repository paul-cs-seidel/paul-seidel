...
// ── Projektdaten ─────────────────────────────────────────────────────────────
const PROJECTS = [
  { id: 'noart',                 title: 'NoArt.',             category: { en: 'Web site',  de: 'Webseite'    }, role: { en: 'DESIGN | FRONT-END DEVELOPMENT | CSS FOCUS',            de: 'DESIGN | FRONT-END ENTWICKLUNG | CSS FOKUS'},             summary: { en: 'Minimalist art portfolio - 3D-textured paintings, dark/light theme, scroll animations. Pure HTML, CSS & Vanilla JS.',                                      de: 'Meine erste Webseite mit html, css und javascript.'},                                                       href: 'https://paul-cs-seidel.github.io/NoArt./',        image: '/assets/projects/noart.png'},
  { id: 'siderun',               title: 'SIDERUN',            category: { en: 'Demo site', de: 'Demoseite'   }, role: { en: 'FUNCTION | FRONT-END DEVELOPMENT | JAVASCRIPT',         de: 'FUNCTION | FRONT-END ENTWICKLUNG | JAVASCRIPT'},          summary: { en: 'SideRun is a tiny front‑end effect: an animated “running” frame. Ideal for navbars, button, and cards. It’s just a small JS runtime plus a CSS file.',     de: 'Ein leichtgewicht JavaScript Project das einen hover running border Effekt baut. '              },          href: 'https://paul-cs-seidel.github.io/SideRun/',       image: '/assets/projects/siderun.png'},
  { id: 'portfolio_2026',        title: 'Portfolio 2026',     category: { en: 'Web site',  de: 'Webseite'    }, role: { en: 'DESIGN | FRONT-END DEVELOPMENT | ANIMATION',            de: 'DESIGN | FRONT-END ENTWICKLUNG| ANIMATION'},              summary: { en: 'Prototype portfolio exploring interactive 3D and frontend motion.',                                                                                        de: 'インタラクティブな3D表現とフロントエンドモーション。'        },                                                     href: 'https://paul-seidel.pages.dev',                   image: '/assets/Hero.png' },
  { id: 'aurascent',             title: 'AuraScent',          category: { en: 'Web site',  de: 'Webseite'    }, role: { en: 'DESIGN | FRONT-END DEVELOPMENT | BACKEND DEVELOPMENT',  de: 'DESIGN | FRONT-END ENTWICKLUNG | BACKEND ENTWICKLUNG'},   summary: { en: 'Development of a full-stack web application featuring backend CRUD functionality and a modern frontend.',                                                  de: 'Development of a full-stack web application featuring backend CRUD functionality and a modern frontend.' }, href: 'https://aurascent-3b4i.onrender.com',             image: '/assets/projects/aurascent.png'},
  { id: 'kernwerksystems',       title: 'Kernwerk Systems',   category: { en: 'Web site',  de: 'Webseite'    }, role: { en: 'DESIGN | FRONT-END DEVELOPMENT | WORDPRESS STYLE',      de: 'DESIGN | FRONT-END ENTWICKLUNG | WORDPRESS STIL'},        summary: { en: 'Demo exploring project browsing and motion-driven interaction.',                                                                                           de: 'プロジェクト閲覧とモーションによるインタラクションデモ。'    },                                                      href: 'https://kernwerk-systems.pages.dev',              image: '/assets/projects/kernwerksystems.png'},
  { id: 'mensuratemporis',       title: 'Mensura Temporis',   category: { en: 'Demo site', de: 'Demoseite'   }, role: { en: 'DESIGN | FRONT-END DEVELOPMENT | APP STYLE',            de: 'DESIGN | FRONT-END ENTWICKLUNG | APP STIL'},              summary: { en: 'Portfolio site from 2022.',                                                                                                                                de: '2022年に制作したポートフォリオサイト。'                      },                                                  href: 'https://mensura-temporis.pages.dev',              image: '/assets/projects/mensuratemporis.png'},
  { id: 'ihkap1',                title: 'IHK AP 1 Lernseite', category: { en: 'Web site',  de: 'Webseite'    }, role: { en: 'STUDYING | KNOWLEDGE | LOCAL STORAGE SYSTEM',           de: 'LERNEN | WISSENSÜBERMITTLUNG| LOKALES SPEICHERSYSTEM'},   summary: { en: 'Showreel presenting motion, WebGL and frontend experiments.',                                                                                              de: 'モーション・WebGL・フロントエンド表現のショーリール。'       },                                                    href: 'https://paul-cs-seidel.github.io/IHK-Lernseite/',  image: '/assets/projects/ihkap1.png'}
];
